...
function SearchComponent({query, paramname, label}) {
  ...
  return (
    <div>
      <div className="flex items-center max-w-[225px] mx-auto mb-2 mt-3">
        ...
        <div className="relative w-full ">
          ...
          />
           <div className="absolute inset-x-48 inset-y-1">
